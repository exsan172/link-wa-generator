    ...
    const generate = () => {
        if (number !== "" && text !== "") {
            ...
            Swal.fire({
                icon:"warning",
                title: "Peringatan !",
                text: "Pastikan isi semua data yang di perlukan!",
                timer:1500,
        ...
        <div className="d-flex bg-wave w-100 justify-content-center align-items-center flex-column">
            ...
            <div className="col-11 col-md-6 shadow bg-white p-4 mt-4 rounded border">
                ...
                <div className="d-flex my-3">
                    <textarea rows="10" className="w-100 border rounded p-2" placeholder="Masukan template text" value={text} onChange={(e) => setText(e.target.value)}></textarea>
                </div>
                <div className="d-flex justify-content-end">
                    {
                        generated === false ?
                            <button className="px-4 py-2 border rounded text-white" style={{backgroundColor:"#25d366"}} onClick={() => generate()}>Buat link</button>
                        :
                            <CopyToClipboard text={text} onCopy={() => copy()}>
                                <button className="px-4 py-2 border rounded text-white" style={{backgroundColor:"#25d366"}}>Salin link</button>
                            </CopyToClipboard>
                    }
                </div>
            </div>
